...
public class SortingExample {
	...
	public static void main(String[] args) {
		...
		// 학생의 점수를 기준으로 정렬
		List<Student> sortedList = studentList.stream() // Stream<Student> 객체 생성
		...
		IntStream sortedIntStream = intStream2.boxed().sorted(Comparator.reverseOrder()).mapToInt(Integer::intValue);
